...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="assets/css/dashmix.min-1.4.css">
    <link rel="stylesheet" id="css-theme" href="assets/css/xeco.min-1.4.css">
        ...
        <nav id="sidebar" aria-label="Main Navigation">
            <div class="smini-visible-block">
                <div class="content-header">
                    <a class="link-fx font-size-lg text-white" href="index.html">
                        <span class="text-white-75">KO</span><span class="text-white">NI</span>
                    </a>
                </div>
            </div>
            <div class="smini-hidden">
                <div class="content-header justify-content-lg-center">
                    <a class="link-fx font-size-lg text-light" href="index.html">
                        <span class="text-white-75">KONI</span>
                        Pekanbaru
                    </a>
                    <div class="d-lg-none">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li class="nav-main-heading">Manajemen</li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                            <i class="nav-main-link-icon fa fa-users"></i>
                            <span class="nav-main-link-name">Atlet</span>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                            ...
                            <span class="nav-main-link-name">Pelatih</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                            <i class="nav-main-link-icon fa fa-user-shield"></i>
                            <span class="nav-main-link-name">Wasit</span>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                            ...
                            <span class="nav-main-link-name">Venue</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                            <i class="nav-main-link-icon fa fa-trophy"></i>
                            <span class="nav-main-link-name">Prestasi</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                    ...
                    <li class="nav-main-heading">Users &amp; Groups</li>
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="">
                ...
                <div>
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0" aria-labelledby="page-header-user-dropdown">
                            <div class="rounded-top font-w600 text-center bg-body-dark p-3">
                                <div class="mb-1">
            ...
            <div class="content content-full">
                        ...
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    <div class="mb-3">
                                        <i class="fa fa-users fa-3x text-xinspire"></i>
                                    </div>
                                    <div class="font-size-h4 font-w600">120 Atlet</div>
                    ...
                    <div class="col-md-4">
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    <div class="mb-3">
                                        <i class="fa fa-user-tie fa-3x text-xsmooth"></i>
                                    </div>
                                    <div class="font-size-h4 font-w600">150 Pelatih</div>
                        ...
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    ...
                                    <div class="font-size-h4 font-w600">3 Wasit</div>
                        ...
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    ...
                                    <div class="font-size-h4 font-w600">3 Venue</div>
                    ...
                    <div class="col-md-4">
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    <div class="mb-3">
                                        <i class="fa fa-trophy fa-3x text-info"></i>
                                    </div>
                                    <div class="font-size-h4 font-w600">3 Prestasi</div>
                    ...
                    <div class="col-md-4">
                        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full">
                                <div class="py-4 text-center">
                                    <div class="mb-3">
                                        <i class="fa fa-newspaper fa-3x text-info"></i>
                                    </div>
                                    <div class="font-size-h4 font-w600">3 Berita</div>
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default text-center">
                        <h3 class="block-title">Catatan Aktivitas</h3>
                    ...
                    <div class="block-content block-content-full">
                        <div class="bg-dark rounded p-3">
                            <pre class="mb-0"><code class="text-body-color-light font-size-sm">
[12:00:06] User X: Login System
[12:00:02] User X: Menambah data pelatih [id : 1, nama: Rendrian Arma]
[12:00:03] User X: Menghapus data atlet [id : 6, nama:  Tarman Ananda]
[12:00:05] User X: Mengedit data atlet [id : 8, nama: Maulana Ali]
[12:00:06] User X: Logout System
            ...
            <div class="content py-0">
                <div class="row font-size-sm">
                    <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                        Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="https://goo.gl/vNS3I" target="_blank">Rendrian Arma</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                        <a class="font-w600" href="https://goo.gl/mDBqx1" target="_blank">KoniPekanbaru</a> &copy; <span data-toggle="year-copy">2018</span>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script src="assets/js/db_gaming.min.js"></script>
</body>
</html>